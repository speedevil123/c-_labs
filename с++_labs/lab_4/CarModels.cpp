...
CarModels::CarModels(const CarModels& _other)
	: CarModels(_other.name_, _other.year_, _other.color_, _other.maxSpeed_, _other.price_)    /*присваиваем значени€ параметрам засчет операторов доступа*/
{}
...
{
	if (&in == &cin)
		cout << "¬ведите модель, год выпуска, цвет, макс. скорость, тип кузова, цену: " << endl;
...
{
	if (&in == &cin)
		cout << "¬ведите количество моделей: ";
	in >> num;
