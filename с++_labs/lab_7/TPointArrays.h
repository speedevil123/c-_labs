...
public:
    ...
    std::ostream& print(std::ostream& out) const
    {
        ...
        if (&out == &std::cout)
        {
            std::cout << "Ёлементы первого массива: " << std::endl;
        }
        ...
        if (&out == &std::cout)
        {
            std::cout << "Ёлементы второго массива: " << std::endl;
        }
    ...
    std::istream& scan(std::istream& in)
    {
        if (&in == &std::cin)
        {
            std::cout << "¬ведите размеры двух массивов через пробел: " << std::endl;
        }
        in >> size1 >> size2;
        delete[] arr1;
        delete[] arr2;
        ...
        if (&in == &std::cin)
        {
            std::cout << "¬ведите элементы первого массива: " << std::endl;
        }
        ...
        for (size_t i = 0; i < size1; i++)
        {
            while (!(in >> arr1[i]))
            {
                std::cerr << "ќшибка: необходимо ввести число." << std::endl;
                in.clear();
        ...
        if (&in == &std::cin)
        {
            std::cout << "¬ведите элементы второго массива: " << std::endl;
        }
    ...
    void max_points_within_distance(double X)
    {
        ...
        if (count1 > count2)
        {
            std::cout << "ѕервый массив удовлетвор€ет условию" << std::endl;
        }

        else if (count1 < count2)
        {
            std::cout << "¬торой массив удовлетвор€ет условию" << std::endl;
        }

        else
        {
            std::cout << "ќба массива удовлетвор€ют условию" << std::endl;
        }
        return;
    }
    ...
    T& operator[] (int index)
    {
        if (index < 0 || size1 <= index || size2 <= index)
            throw TIndexOutOfRange(index, "¬ операторе: T& operator [] (int index)\n");
        if (index < size1)
        {
            return arr1[index];
        }
